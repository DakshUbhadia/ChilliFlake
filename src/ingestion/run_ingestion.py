...
def main() -> None:
    ...
    total_runs_errored = total_runs_no_artifact = 0
    ...
    logger.info('  Runs fetched=%d  no_artifact=%d  errored=%d', len(runs), total_runs_no_artifact, total_runs_errored)
    logger.info('  Builds ingested=%d  test_runs inserted=%d', total_builds_inserted, total_test_runs_inserted)
